...
const projects = [
  {
    ...
    desc: "AI-powered learning platform with personalized study plans, smart quizzes, and progress tracking. Built with MERN stack and integrated OpenAI for intelligent content generation.",
    tech: ["React", "Node.js", "MongoDB", "OpenAI API", "Express"],
    live: "https://padh-ai-pied.vercel.app/",
    github: "https://github.com/Arushi026",
    tag: "AI · EDUCATION", num: "01", emoji: "🤖",
  },
  {
    name: "MySphere",
    role: "Full Stack Developer",
    desc: "Modern social media platform with real-time features, post sharing, follow system, and responsive design. Features JWT authentication and cloud image storage.",
    tech: ["React", "Node.js", "MongoDB", "Socket.io", "Cloudinary"],
    live: null,
    github: "https://github.com/Arushi026",
    tag: "SOCIAL · REAL-TIME", num: "02", emoji: "🌐",
  },
  {
    name: "Portfolio OS",
    role: "Designer & Developer",
    desc: "This portfolio — a futuristic OS-inspired personal site with 3D mouse interactions, magnetic effects, cinematic animations, and a cohesive dark design system.",
    tech: ["React", "Vite", "CSS Animations", "Canvas API"],
    live: "#",
    github: "https://github.com/Arushi026",
    tag: "3D · INTERACTIVE", num: "03", emoji: "✨",
  },
];
  ...
  return (
    <div
      ...
      <div style={{ display:"flex", flexWrap:"wrap", gap:"6px", marginBottom:"20px" }}>
        {p.tech.map(t => (
          <span key={t} style={{ background:"rgba(74,222,128,0.07)", border:"1px solid rgba(74,222,128,0.2)", borderRadius:"4px", padding:"2px 9px", fontSize:"11px", color:"rgba(255,255,255,0.55)" }}>{t}</span>
        ))}
      </div>
      <div style={{ display:"flex", gap:"16px", alignItems:"center" }}>
        {p.live && p.live !== "#" && (
          <a href={p.live} target="_blank" rel="noopener noreferrer" style={{ color:"#4ade80", fontSize:"12px", letterSpacing:"0.08em", textDecoration:"none", fontWeight:700 }}>↗ LIVE DEMO</a>
        )}
        <a href={p.github} target="_blank" rel="noopener noreferrer"
          style={{ color:"rgba(255,255,255,0.35)", fontSize:"12px", textDecoration:"none", letterSpacing:"0.08em", transition:"color 0.2s" }}
